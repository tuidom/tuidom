...
import { serializeKey } from "@tuidom/core/input/serializeKey";
import { serializeMouse, type SerializeMouseInit } from "@tuidom/core/input/serializeMouse";
import type { Grid } from "@tuidom/core/rendering/grid";
import { emptyGridSnapshot, type GridSnapshot, snapshotGrid } from "@tuidom/core/rendering/gridSnapshot";

/**
 * Terminal backend that runs the real application without a real terminal.
 *
 * Unlike {@link import("@tuidom/terminal-backend/nodeTerminalBackend").NodeTerminalBackend} it never
 ...
 * injected the same way {@link import("@tuidom/testing/mockTerminalBackend").MockTerminalBackend}
